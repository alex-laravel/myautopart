...
{{--        </div>--}}
        ...
        <div class="product-card__image">
            <div class="image image--type--product">
                <a href="{{ route('frontend.parts.details', $part->id) }}" class="image__body">
...
{{--            </button>--}}
            ...
            <a class="product-card__addtocart-full text-center" style="line-height: 36px" href="{{ route('frontend.cart.add', $part->id) }}" role="button">
                {{ trans('buttons.frontend.shop.add_to_cart') }}
            </a>
