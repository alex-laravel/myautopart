...
@section('title', 'Подробное описание запчасти')
                                        ...
                                        <div class="product-gallery__featured">
                                            ...
                                            <div class="owl-carousel">
                                                @foreach ($part->documents as $document)
                                                    <a class="image image--type--product" href="{{ asset('assets/articles/' . $document->assetDocumentName) }}" target="_blank" data-width="700" data-height="700">
                                                        <div class="image__body">
                                                            <img class="image__tag" src="{{ asset('assets/articles/' . $document->assetDocumentName) }}" alt="">
                                                        </div>
                                                    </a>
                                                @endforeach
                                            </div>
