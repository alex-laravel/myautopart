                            ...
                            <div class="card-body card-body--padding--2">
                                ...
                                <form action="{{ route('register') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label for="email">{{ trans('labels.auth.register.form.name') }}</label>
                                        <input id="name" name="name" type="text" class="form-control @error('name') is-invalid @enderror" placeholder="{{ trans('labels.auth.register.form.name') }}" value="{{ old('name') }}" maxlength="255" required autofocus>
